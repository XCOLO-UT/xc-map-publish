...
declare const useFeature: <TData>(xcMap: Map | undefined) => {
    createFeature: (marker: IMarker<TData>, featureName: string, style?: Style, getAnimationProperty?: ((data: Partial<IAnimationParams> | undefined) => IAnimationProperty) | undefined) => Feature;
